...
//Ascending order
const sortedNumberArray = unsortedNumberArray.sort((elementA,elementB) => elementA - elementB);
...
const unsortedStringArray = ["A","D","C","B"];
//console.log(unsortedStringArray.sort())